...
def add_product():
    ...
    try:
        ...
        product_image_url = request.form['product_image']

        new_product = {'name': product_name, 'price': product_price, 'image_path': product_image_url}
        ...
        return f"Произошла ошибка при добавлении товара: {e}", 500
